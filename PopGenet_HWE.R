...
#------------------------------------------------------------------------------
	check_list <- check_integer(nb_AA, label = "nb_AA", min_x = 0, rtn = check_list)
	check_list <- check_integer(nb_Aa, label = "nb_Aa", min_x = 0, rtn = check_list)
	check_list <- check_integer(nb_aa, label = "nb_aa", min_x = 0, rtn = check_list)
	check_list <- check_integer(pegas_B, label = "pegas_B", min_x = 1, rtn = check_list)
	check_list <- check_integer(HardyWeinberg_B, label = "HardyWeinberg_B", min_x = 1, rtn = check_list)
#------------------------------------------------------------------------------
...
#  Compute population statistics using HardyWeinberg
#==============================================================================
...
{
	param_checking <- check_parameters(nb_AA, nb_Aa, nb_aa, HardyWeinberg_B = HardyWeinberg_B)
	# print(param_checking)
...
#   see Graffelman J 2021 Exploring Diallelic Genetic Markers: The HardyWeinberg Package
		HW_test_1 <- HWChisq(pop_data$genotype_count, cc = 0.0, verbose = FALSE) 
		HW_test_2 <- HWChisq(pop_data$genotype_count, cc = 0.5, verbose = FALSE) 
		HW_test_3 <- HWLratio(pop_data$genotype_count, verbose = FALSE) 
		HW_test_4 <- HWExact(pop_data$genotype_count, pvaluetype = "selome", verbose = FALSE) 
		HW_test_5 <- HWExact(pop_data$genotype_count, pvaluetype = "dost", verbose = FALSE) 
		HW_test_6 <- HWExact(pop_data$genotype_count, pvaluetype = "midp", verbose = FALSE) 
		if (HardyWeinberg_perm_flag) {
			HW_test_7 <- HWPerm(pop_data$genotype_count, nperm = HardyWeinberg_B, verbose = FALSE)
		} else {
...
#------------------------------------------------------------------------------
		...
		pop_HardyWeinberg_data <- list(param = param_checking)
	}
#------------------------------------------------------------------------------
...
#==============================================================================
# compute_pegas_pop
#  Compute population statistics using pegas
#==============================================================================
...
#------------------------------------------------------------------------------
		...
		pop_pegas_data <- list(param = param_checking)
	}
#------------------------------------------------------------------------------
